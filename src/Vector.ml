...
let init ~dummy:(dummy: 'a) (n: int) (f: (int) -> 'a) : 'a t =
  ...
  begin
    let o = n - 1 in
    let o1 = 0 in
    for i1 = o1 to o do let o2 = a.data in o2.(i1) <- (f i1) done; a
  end
...
let fold_right (a: 'a t) (f: 'a -> ('b -> 'b)) (acc: 'b) : 'b =
  ...
  begin
    let o = 0 in
    let o1 = n - 1 in
    for i3 = o1 downto o do let o2 = (f (get (a) i3)) (!r) in r := o2 done;
    !r
  end
...
let map ~dummy:(dummy: 'b) (a: 'a t) (f: 'a -> 'b) : 'b t =
  ...
  begin
    ...
    let o1 = 0 in
    for i4 = o1 to o do
      let x = get (a) i4 in let o2 = a_new.data in o2.(i4) <- (f x) done;
    a_new
  end
...
let mapi ~dummy:(dummy: 'b) (a: 'a t) (f: (int) -> ('a -> 'b)) : 'b t =
  ...
  begin
    ...
    let o1 = 0 in
    for i5 = o1 to o do
      let x = get (a) i5 in let o2 = a_new.data in o2.(i5) <- ((f i5) x) done;
    a_new
  end
