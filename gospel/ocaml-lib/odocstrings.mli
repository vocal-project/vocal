...
(** Odocstrings immediately preceding a token *)
val set_pre_docstrings : Lexing.position -> docstring list -> unit

(** Odocstrings immediately following a token *)
val set_post_docstrings : Lexing.position -> docstring list -> unit

(** Odocstrings not immediately adjacent to a token *)
val set_floating_docstrings : Lexing.position -> docstring list -> unit

(** Odocstrings immediately following the token which precedes this one *)
val set_pre_extra_docstrings : Lexing.position -> docstring list -> unit

(** Odocstrings immediately preceding the token which follows this one *)
...
val docs_attr : docstring -> Oparsetree.attribute

(** Convert item documentation to attributes and add them to an
    attribute list *)
val add_docs_attrs : docs -> Oparsetree.attributes -> Oparsetree.attributes
...
val info_attr : docstring -> Oparsetree.attribute

(** Convert field info to attributes and add them to an
    attribute list *)
val add_info_attrs : info -> Oparsetree.attributes -> Oparsetree.attributes
...
val text_attr : docstring -> Oparsetree.attribute

(** Convert text to attributes and add them to an attribute list *)
val add_text_attrs : text -> Oparsetree.attributes -> Oparsetree.attributes
