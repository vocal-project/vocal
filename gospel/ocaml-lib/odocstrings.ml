...
(* Vdocstring constructors and destructors *)
...
(* Odocstrings attached to constructors or fields *)
...
(* Odocstrings not attached to a specific item *)
...
(* Odocstrings from parser actions *)
